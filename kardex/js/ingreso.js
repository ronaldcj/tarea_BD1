 ...
 //agregar las filas del boton agregar
  function agregar(){
    ...
    var vu = document.getElementById("e_valor_unitario").value;
    var unidad = document.getElementById("unidad").value;

    var fila = '<tr class="selected" id="fila'+cont+'"><td><input type="hidden" name="id_item[]" readonly value="'+id_item+'"><input type="text" name="codigo[]" readonly value="'+cod+'"></td><td><input type="text" name="cantidad[]" readonly value="'+cant+'"></td><td><input type="text" name="vu[]" readonly value="'+vu+'"></td><td><input type="text" name="unidad[]" readonly value="'+unidad+'"></td><td><input type="text" name="descripcion[]" readonly value="'+des+'"></td><td><a href="#" onclick="funcionElimnarFila('+cont+')" class="eliminar"><i class="fas fa-trash fa-2x" style="color: red;"></a></td></tr>';

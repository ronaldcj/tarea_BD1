 <?php
	...
	$nota = "SELECT max(nro_nota) nro FROM alm.salida_k";
...
<body>
	<div class="container-fluid">
		...
		<div class="col-md-10" >
			...
			<div class="row">				
				...
				<div class="col-md-3">
					...
					<a href="kardexIngreso.php" class="btn btn-danger">Nota Ingreso</a>
				</div>
			...
			<br>
		    	...
		    	<div class="row" >
		    		...
		    		<div class="col-md-2">
		    			<label>Valor:</label>			    				    			
		        		<input class="form-control" id="vu_pp" type="text" name="vu_pp" readonly>
		    		</div>						        		
		...
		<div class="row">
			...
			<input type="submit" name="enviar_salida" class="btn btn btn-warning" value="Guardar Nota">
			</form>
